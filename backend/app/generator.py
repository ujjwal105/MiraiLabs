...
TIER_CONFIG = {
    ...
    CompanyTier.REGULAR: dict(
        count=18,
        cgpa_range=(6.5, 7.6),
        duration_choices=[15, 30],
        panels_range=(3, 5),
        shortlist_range=(30, 80),
    ...
    CompanyTier.NICHE: dict(
        count=8,
        cgpa_range=(7.0, 8.2),
        duration_choices=[30, 45],
        panels_range=(2, 3),
        shortlist_range=(12, 32),
        day_weights={2: 0.4, 3: 0.3, 4: 0.3},
